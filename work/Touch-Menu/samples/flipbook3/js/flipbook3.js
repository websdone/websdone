...
var sampleName = 'flipbook3',
	samplePath = 'samples/flipbook3/';
...
function loadPage(page) {
	...
	var img = $('<img />');
	img.load(function() {
		var container = $('.flipbook3 .p'+page);
		img.css({width: '100%', height: '100%'});
		img.appendTo($('.flipbook3 .p'+page));
		...
		when: {
			...
			change: function(event, scale) {
				...
				if (scale==1) {
					...
					$('.flipbook3').removeClass('animated').addClass('zoom-in');
			...
			zoomOut: function () {
				...
				setTimeout(function(){
					$('.flipbook3').addClass('animated').removeClass('zoom-in');
				}, 0);
