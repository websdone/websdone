...
var sampleName = 'flipbook5',
	samplePath = 'samples/flipbook5/';
...
function loadPage(page) {
	...
	var img = $('<img />');
	img.load(function() {
		var container = $('.flipbook5 .p'+page);
		img.css({width: '100%', height: '100%'});
		img.appendTo($('.flipbook5 .p'+page));
		...
		when: {
			...
			change: function(event, scale) {
				...
				if (scale==1) {
					...
					$('.flipbook5').removeClass('animated').addClass('zoom-in');
			...
			zoomOut: function () {
				...
				setTimeout(function(){
					$('.flipbook5').addClass('animated').removeClass('zoom-in');
				}, 0);
