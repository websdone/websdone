...
var sampleName = 'flipbook1',
	samplePath = 'samples/flipbook1/';
...
function loadPage(page) {
	...
	var img = $('<img />');
	img.load(function() {
		var container = $('.flipbook1 .p'+page);
		img.css({width: '100%', height: '100%'});
		img.appendTo($('.flipbook1 .p'+page));
		...
		when: {
			...
			change: function(event, scale) {
				...
				if (scale==1) {
					...
					$('.flipbook1').removeClass('animated').addClass('zoom-in');
			...
			zoomOut: function () {
				...
				setTimeout(function(){
					$('.flipbook1').addClass('animated').removeClass('zoom-in');
				}, 0);
