...
var sampleName = 'flipbook9',
	samplePath = 'samples/flipbook9/';
...
function loadPage(page) {
	...
	var img = $('<img />');
	img.load(function() {
		var container = $('.flipbook9 .p'+page);
		img.css({width: '100%', height: '100%'});
		img.appendTo($('.flipbook9 .p'+page));
		...
		when: {
			...
			change: function(event, scale) {
				...
				if (scale==1) {
					...
					$('.flipbook9').removeClass('animated').addClass('zoom-in');
			...
			zoomOut: function () {
				...
				setTimeout(function(){
					$('.flipbook9').addClass('animated').removeClass('zoom-in');
				}, 0);
