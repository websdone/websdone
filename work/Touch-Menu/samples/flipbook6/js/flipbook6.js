...
var sampleName = 'flipbook6',
	samplePath = 'samples/flipbook6/';
...
function loadPage(page) {
	...
	var img = $('<img />');
	img.load(function() {
		var container = $('.flipbook6 .p'+page);
		img.css({width: '100%', height: '100%'});
		img.appendTo($('.flipbook6 .p'+page));
		...
		when: {
			...
			change: function(event, scale) {
				...
				if (scale==1) {
					...
					$('.flipbook6').removeClass('animated').addClass('zoom-in');
			...
			zoomOut: function () {
				...
				setTimeout(function(){
					$('.flipbook6').addClass('animated').removeClass('zoom-in');
				}, 0);
