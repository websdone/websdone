...
var sampleName = 'flipbook7',
	samplePath = 'samples/flipbook7/';
...
function loadPage(page) {
	...
	var img = $('<img />');
	img.load(function() {
		var container = $('.flipbook7 .p'+page);
		img.css({width: '100%', height: '100%'});
		img.appendTo($('.flipbook7 .p'+page));
		...
		when: {
			...
			change: function(event, scale) {
				...
				if (scale==1) {
					...
					$('.flipbook7').removeClass('animated').addClass('zoom-in');
			...
			zoomOut: function () {
				...
				setTimeout(function(){
					$('.flipbook7').addClass('animated').removeClass('zoom-in');
				}, 0);
