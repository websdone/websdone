...
var sampleName = 'flipbook2',
	samplePath = 'samples/flipbook2/';
...
function loadPage(page) {
	...
	var img = $('<img />');
	img.load(function() {
		var container = $('.flipbook2 .p'+page);
		img.css({width: '100%', height: '100%'});
		img.appendTo($('.flipbook2 .p'+page));
		...
		when: {
			...
			change: function(event, scale) {
				...
				if (scale==1) {
					...
					$('.flipbook2').removeClass('animated').addClass('zoom-in');
			...
			zoomOut: function () {
				...
				setTimeout(function(){
					$('.flipbook2').addClass('animated').removeClass('zoom-in');
				}, 0);
