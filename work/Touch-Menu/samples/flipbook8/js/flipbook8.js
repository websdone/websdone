...
var sampleName = 'flipbook8',
	samplePath = 'samples/flipbook8/';
...
function loadPage(page) {
	...
	var img = $('<img />');
	img.load(function() {
		var container = $('.flipbook8 .p'+page);
		img.css({width: '100%', height: '100%'});
		img.appendTo($('.flipbook8 .p'+page));
		...
		when: {
			...
			change: function(event, scale) {
				...
				if (scale==1) {
					...
					$('.flipbook8').removeClass('animated').addClass('zoom-in');
			...
			zoomOut: function () {
				...
				setTimeout(function(){
					$('.flipbook8').addClass('animated').removeClass('zoom-in');
				}, 0);
