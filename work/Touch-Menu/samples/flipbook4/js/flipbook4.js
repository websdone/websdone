...
var sampleName = 'flipbook4',
	samplePath = 'samples/flipbook4/';
...
function loadPage(page) {
	...
	var img = $('<img />');
	img.load(function() {
		var container = $('.flipbook4 .p'+page);
		img.css({width: '100%', height: '100%'});
		img.appendTo($('.flipbook4 .p'+page));
		...
		when: {
			...
			change: function(event, scale) {
				...
				if (scale==1) {
					...
					$('.flipbook4').removeClass('animated').addClass('zoom-in');
			...
			zoomOut: function () {
				...
				setTimeout(function(){
					$('.flipbook4').addClass('animated').removeClass('zoom-in');
				}, 0);
